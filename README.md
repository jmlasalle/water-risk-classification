...
We have taken an additional step before creating the app: the polygons on the GeoJSON file created with the cluster’s labels were dissolved, and the geodataframe was saved as a shapefile, due to its reduced size. That enabled us to upload the file to GitHub and have our app hosted there.
